...
void calculate_turret_position()
{
    ...
    int turret_ratio = 24000;

    //int turret_factor = turret_encoder_count < 0 ? turret_ratio - turret_encoder_count : turret_encoder_count;
    turret_position = int(turret_encoder_count / (turret_ratio / 360));
